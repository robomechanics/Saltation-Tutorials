...
matlabFunction(G1,'File','calc_g12','Vars',[{t}, {states},{inputs},{parameters}]);
matlabFunction(DG1,'File','calc_Dg12','Vars',[{states},{inputs},{parameters}]);
matlabFunction(DtG1,'File','calc_Dtg12','Vars',[{t}, {states},{inputs},{parameters}]);
matlabFunction(G2,'File','calc_g21','Vars',[{t}, {states},{inputs},{parameters}]);
matlabFunction(DG2,'File','calc_Dg21','Vars',[{states},{inputs},{parameters}]);
matlabFunction(DtG2,'File','calc_Dtg21','Vars',[{t}, {states},{inputs},{parameters}]);
...
matlabFunction(salt1,'File','calc_salt12','Vars',[{t}, {states},{inputs},{parameters}]);
matlabFunction(salt2,'File','calc_salt21','Vars',[{t}, {states},{inputs},{parameters}]);